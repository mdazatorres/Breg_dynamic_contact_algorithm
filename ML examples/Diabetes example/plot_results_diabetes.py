...
from integrators import CM, NAG, RGD, CRGD, CNAG
from example_diabetes_LR import gradLp, Lp, loss_func_test, n, Xtrain, Ytrain
...
def plot_results(L1,L2, L3, L5, ylabel):
    plt.figure(figsize=(10, 7))
    plot_r(L1, color='b', marker='D', fillstyle='none', markevery=5, method='CM')
    plot_r(L2, color='k', marker='H', fillstyle='none', markevery=5, method='CRGD')
...
L2, L2t, E2, E2t = results(num_trials, steps, CRGD)
...
plot_results( L1,L2, L3, L5, ylabel='loss')
plot_results(L1t, L2t, L3t, L5t, ylabel='loss')
plot_results(E1, E2, E3, E5, ylabel='classification error')
plot_results(E1t, E2t, E3t,E5t, ylabel='classification error')
